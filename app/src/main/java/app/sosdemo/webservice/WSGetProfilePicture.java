...
/**
 * Created by indianic on 25/02/17.
 */

public class WSGetProfilePicture {
    private Context context;
    private boolean isSuccess = false;
    private String message = "";

    public WSGetProfilePicture(final Context context) {
     ...
     */
    public boolean executeService(final String macid, final String simid) {
        try {
            final String url = WSConstants.BASE_URL + WSConstants.METHOD_PROFILE_GET + generateRequest(macid, simid);
    ...
    private String generateRequest(final String macid, final String simid) {
