...
import com.lkland.videocompressor.responsehandler.IResponseHandler;
...
public class CompressionService extends AbstractCompressionService{
    ...
    private void configureCompressionResponse(){
		...
		_compressor.setOnProgressListener(prh);
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
        ...
        return super.onStartCommand(intent, flags, this.START_STICKY);
    }
